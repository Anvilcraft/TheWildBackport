...
public class InstrumentTags {
    public static final TagBuilder<Instrument> TAGS
        = TagBuilder.create(WBRegistries.INSTRUMENT.registry(), "minecraft");

    public static final TagKey<Instrument> REGULAR_GOAT_HORNS
        = TAGS.create("regular_goat_horns");
    public static final TagKey<Instrument> SCREAMING_GOAT_HORNS
        = TAGS.create("screaming_goat_horns");
