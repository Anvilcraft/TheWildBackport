...
public class WBGameRules {
    ...
    public static final GameRules.Key<GameRules.BooleanValue> DO_WARDEN_SPAWNING = create(
        "doWardenSpawning",
        GameRules.Category.SPAWNING,
        BooleanValueAccessor.callCreate(true)
    );

    private static <T extends GameRules.Value<T>> GameRules.Key<T>
    create(String key, GameRules.Category category, GameRules.Type<T> type) {
